        ...
        >
          ...
          >
            <GlowCard variant="premium" hover={false} className="p-6 md:p-8">
              ...
              <button
                onClick={onClose}
                className="absolute top-4 right-4 p-2 rounded-lg text-luxury-gray hover:text-white hover:bg-luxury-lighter transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {mode === "login" && (
                  <div className="flex items-center justify-between">
                    ...
                    <button type="button" className="text-sm text-gold hover:text-brand-orange">
                      Forgot password?
                    </button>
                  </div>
                )}

                <GoldButton type="submit" className="w-full" loading={isLoading}>
                ...
                {mode === "login" ? (
                  <>
                    ...
                    <button
                      type="button"
                      onClick={toggleMode}
                      className="text-gold hover:text-brand-orange font-medium"
                    >
                      Sign up
                    </button>
                  </>
